              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  ...
                  <div class="tab-pane fade" id="custom-tabs-one-status" role="tabpanel" aria-labelledby="custom-tabs-one-messages-status">
                    <?php
                    $totalStatusCounselor = count($statusCounselor);
                    $i = 1;
                    ?>
                    <input type="hidden" id="follow-up-status-counselor-length" value="<?= $totalStatusCounselor ?>" />
                    <?php foreach ($statusCounselor as $stat) : ?>
                      <?php
                      $i++;
                      ?>
                      <?php
                      if (isset($student[0]->status) ? $student[0]->status == 1 : 1) {
                        $disabled = $stat->id == 2 ?: "";
                      }
                      if (isset($student[0]->status) ? $student[0]->status == 2 : 1) {
                        $disabled = $stat->id == 3 ?: "";
                      }
                      if (isset($student[0]->status) ? $student[0]->status == 3 : 1) {
                        $disabled = $stat->id == 4 ?: "";
                      }
                      if (isset($student[0]->status) ? $student[0]->status == 4 : 1) {
                        $disabled = $stat->id == 5 ?: "";
                      }
                      if (isset($student[0]->status) ? $student[0]->status == 5 : 1) {
                        $disabled = $stat->id == 7 ?: "";
                      }
                      if (isset($student[0]->status) ? $student[0]->status == 6 : 1) {
                        $disabled = "disabled";
                      }
                      if (isset($student[0]->status) ?  $student[0]->status == 7 : 1) {
                        $disabled = "disabled";
                        // $stat->id == 7 ?: ""
                        // if ($stat->id == 6) {
                        //   $disabled = ""; // disabled 
                      ...
                      <div class="form-check">
                        <?php if ($stat->name != "Prospect") : ?>
                          <input class="form-check-input" type="radio" name="follow-up-status-counselor" id="follow-up-status-counselor-<?= $i ?>" data-status-name="<?= $stat->name ?>" value="<?= $stat->id ?>" <?= $stat->id == $student[0]->status ? 'checked' : $disabled ?>>
                          <label class="form-check-label" for="follow-up-status-counselor-<?= $i ?>">
                            <?= $stat->name ?>
                          </label>
                        <?php endif; ?>
                      </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <select id="select-country" name="select-country" class="form-control">
